...
public class Part2 extends JFrame implements ActionListener, Runnable{
    // 클라이언트 화면용
    ...
    public Part2(String ip, int port, Customer customer) {
    ...
    public Part2(String ip, int port, String restaurant) {
        name = restaurant;
        // frame 기본 설정
        setTitle("챗팅");
        setSize(550, 400);
